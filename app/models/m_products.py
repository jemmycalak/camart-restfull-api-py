...
class t_product(db.Model, CRUD):
    ...
    rel_cart = db.relationship('t_cart', backref='t_product', lazy='dynamic')

    def __init__(self, id, product_nm, product_price, product_desc, product_weight, product_color, product_img ):
        self.id = id
